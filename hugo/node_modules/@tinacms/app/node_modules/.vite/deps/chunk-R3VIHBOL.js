...
var PopperContent = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React33.useState(null);
...
var RovingFocusGroupImpl = React34.forwardRef((props, forwardedRef) => {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React34.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection(__scopeRovingFocusGroup);
  const isClickFocusRef = React34.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React34.useState(0);
  React34.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime13.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React34.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React34.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React34.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React34.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React34.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(PortalProvider3, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime17.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime17.jsx)(Portal, { asChild: true, container, children }) }) });
};
        ...
        children: (0, import_jsx_runtime17.jsxs)(
          Content2,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime17.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime17.jsx)(Root4, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
//# sourceMappingURL=chunk-R3VIHBOL.js.map
