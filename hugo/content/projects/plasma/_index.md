...
specs:
  ...
  - key: "Type"
    value: "R&D"
highlights:
  - key: " Our team reached a major milestone this year by successfully firing a pulsed plasma thruster inside a chamber pumped down to five times ten to the minus five mbar, demonstrating stable plasma pulses in true space like vacuum. This work was consolidated into our first peer reviewed conference publication at the International Electric Propulsion Conference, where we presented our full PPT architecture, pulse characterisation and system design. "
    value: " "
---
...
{{< flexbox >}}
    {{< specs >}}
    {{< logotype logo="/icons/plasma.png" >}}
{{< /flexbox >}}
...
{{< component-section component="System Integration" image="/images/originalQuality/plasma-support.png" 
object-fit="scale-down" >}}
